...
public final class JedisNodeClientTest {
    ...
    private final JedisNodeClient jedisNodeClient = new JedisNodeClient(this.jedisPool);
    ...
    public void returnResourceOnGetSessionsFail() throws Exception {
        ...
        this.jedisNodeClient.getSessions(SESSIONS_KEY);
    ...
    public void getSessions() {
        ...
        Set<String> result = this.jedisNodeClient.getSessions(SESSIONS_KEY);
    ...
    public void returnResourceOnCountFail() throws Exception {
        ...
        this.jedisNodeClient.count(SESSIONS_KEY);
    ...
    public void count() {
        ...
        Integer result = this.jedisNodeClient.count(SESSIONS_KEY);
