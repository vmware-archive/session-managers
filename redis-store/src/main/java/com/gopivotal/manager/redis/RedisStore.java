...
public final class RedisStore extends AbstractLifecycle implements RedisStoreManagement, Store {
    ...
    public int getSize() {
        return this.lockTemplate.withReadLock(new LockTemplate.LockedOperation<Integer>() {
            ...
            @Override
            public Integer invoke() {
                return RedisStore.this.jedisTemplate.withJedis(new JedisTemplate.JedisOperation<Integer>() {
    ...
    public String[] keys() {
        return this.lockTemplate.withReadLock(new LockTemplate.LockedOperation<String[]>() {
            ...
            @Override
            public String[] invoke() {
                return RedisStore.this.jedisTemplate.withJedis(new JedisTemplate.JedisOperation<String[]>() {
    ...
    public Session load(final String id) {
        return this.lockTemplate.withReadLock(new LockTemplate.LockedOperation<Session>() {
            ...
            public Session invoke() {
                return RedisStore.this.jedisTemplate.withJedis(new JedisTemplate.JedisOperation<Session>() {
    ...
    public void save(final Session session) {
        this.lockTemplate.withReadLock(new LockTemplate.LockedOperation<Void>() {
            ...
            @Override
            public Void invoke() {
                return RedisStore.this.jedisTemplate.withJedis(new JedisTemplate.JedisOperation<Void>() {

                    @Override
                    public Void invoke(Jedis jedis) throws IOException {
